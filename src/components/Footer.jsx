...
export default function Footer({ onFeedbackSubmitted }) {
  ...
  const handleSubmit = (e) => {
    ...
    const savedFeedback = localStorage.getItem("BIGO_FEEDBACK_DB");
    const db = savedFeedback ? JSON.parse(savedFeedback) : [];
    ...
    const updatedDb = [newFeedback, ...db];
    localStorage.setItem("BIGO_FEEDBACK_DB", JSON.stringify(updatedDb));
