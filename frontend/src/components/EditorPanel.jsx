...
import { Play, Sparkles, Lock, Database } from "lucide-react";
...
export default function EditorPanel({
  ...
  const handleLanguageChange = (e) => {
    ...
    if (lang === "rust" && userTier !== "premium") {
      showToast("Rust support is a Premium feature! Please switch to the Paid (Premium) tier at the top to unlock.", "warning");
      return;
    }
